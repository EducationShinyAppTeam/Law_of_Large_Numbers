    ...
    tabItems(
      tabItem(
        ...
        fluidPage(
          ...
          h4(
            tags$li(
              "Pick a population from one of the continuous types (left-skewed; right-skewed; symmetric; or bimodal) or one of the discrete examples (rolls of an astragalus; random songs from ipod shuffle;
                                 or accident occurrence)."
            )
          ),
          h4(
            tags$li(
              "Use the sliders to adjust the parameters of the population model you chose."
            )
          ),
          h4(
            tags$li(
              "Use the sliders to decide how many times you will repeat the chance process you will run (i.e. #of trials or sample size) and how many sample paths you will observe
          ...
          h4(
            "The app was modified and recoded by Yingjie(Chelsea) Wang in February 2018."
          ),
